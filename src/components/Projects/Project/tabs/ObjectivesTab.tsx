...
export function ObjectivesTab({ project, locale, onUpdateProject }: ObjectivesTabProps) {
  ...
  const getOverallObjectivesProgress = () => {
    ...
    const completed = project.objectives.filter(obj => obj.status === 'completed').length;
        ...
        : (
            project.objectives.map(objective => (
              <ObjectiveItem
                ...
                allObjectives={project.objectives}
              />
            ))
          )}
